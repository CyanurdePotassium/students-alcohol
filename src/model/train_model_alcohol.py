...
# Walc, Dalc - zsumowane w Salc
columns_to_exclude = columns_to_exclude = ['G1_por', 'G2_por', 'G1_mat', 'G2_mat', 'G1_avg', 'G2_avg', 'G3_avg', 'G3_mat', 'G3_por', 'Walc', 'Dalc']
data_subset = data.drop(columns=columns_to_exclude)

# Podział na zbiór cech i zbiór etykiet
X = data_subset.drop('Salc', axis=1)
y = (data['Salc'] >= 0.4).astype(int)  # Klasyfikacja binarna, próg "spozycia" 40%
